...
- **`MultiverseRemove`**
  - **Description**: Removes an existing *Universe* from the *Multiverse*, after asking for confirmation since this deletes the *Universe*'s persisted data and cannot be undone.
  - **Arguments**: 
